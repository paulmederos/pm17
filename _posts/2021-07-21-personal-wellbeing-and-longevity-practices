...
Food journaling (1-2wks) when needed to diagnose issues
...
Personal Training
    ...
    - Future Fit for virtual. They handle my programming. My performance coach  is a certified PT (DPT, OCS, CSCS) Current focus is bodyweight, lower-weight resistance and mobility injury rehab to prep me for heavier barbell work. We text via app almost daily.
